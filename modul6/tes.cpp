...
{
    if (isStackPassengerEmpty() == false)
    {
    ...
    do
    {
        ...
        case 1:
            do
            {
                ...
                pushPassengerData(passengerName, passengerAge, passengerGender,
                                  passengerDestination, passengerOrigin, passengerSeatNumber);
