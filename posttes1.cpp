...
{
    if (theAccountHead == NULL && theAccountTail == NULL)
    {
        return true;
    }
    else
...
bool theAccountUsernameChecker(string usernameChecked)
{
    ...
    else
    {
        ...
        do
        {
            ...
            theAccountHelper = NULL;
        } while (theAccountHelper != NULL && theAccountHelper->theusername != usernameChecked);
    }
}
void accountMaker()
{
    ...
    do
    {
        cout << "\t" << "Enter username : ";
        cin >> usernameCreate;
        if (theAccountUsernameChecker(usernameCreate) == false)
        {
            cout << "\t" << "The username has been owned by the other user" << endl;
            cout << "\t" << "Please choose other username" << endl;
        }
    } while (theAccountUsernameChecker(usernameCreate) == false);
    ...
    do
    {
        cout << "\t" << "Your role (1 - 3): ";
        cin >> userroleCreate;
        if (userroleCreate != 1 && userroleCreate != 2 && userroleCreate)
        {
...
void readUserAccount()
{
    ...
    else
    {
        ...
        do
        {
            ...
            cout << "\t" << "Password : " << theAccountHead->thepassword << endl;
...
void doctorPage()
{
    ...
    do
    {
        ...
        if (doctorChoice > 0)
        {
            cout << "\t" << "You're very busy todays Doctor" << endl;
            getch();
        }
        else
        {
...
void adminPage()
{
    ...
    do
    {
        ...
        if (adminChoice > 0)
        {
            cout << "\t" << "You're very busy todays" << endl;
            getch();
        }
        else
        {
...
void patientPage()
{
    ...
    do
    {
        ...
        if (patientChoice > 0)
        {
            cout << "\t" << "You're very healty todays" << endl;
            getch();
        }
        else
        {
...
void loginPage()
{
    ...
    do
    {
        ...
        else
        {
            ...
            } while (theAccountHelper != NULL && isUsernameFounded == false);
            if (isUsernameFounded)
            {
                ...
                else
                {
                    ...
                    cout << "\t" << "Login Failed : Password Incorrect..." << endl
                         << endl;
                    loginTrial++;
                }
            }
            ...
            {
                isUsernameFounded = false;
                cout << "\t" << "Login Failed : No Username..." << endl
                     << endl;
                loginTrial++;
            }
        }
    } while (loginTrial <= 3 && loginState == false);
    if (loginState)
    {
        if (theAccountHelper->userrole == 1)
        {
...
void homePage()
{
    do
    {
        system("cls");
        welcomePage();
        cout << "\t" << "Please login or register if you havent account" << endl;
        cout << "\t" << "1. Login" << endl;
